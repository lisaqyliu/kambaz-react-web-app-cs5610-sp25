import { FormGroup, FormLabel, FormControl, FormSelect, Form, InputGroup, Row, Col, Button } from 'react-bootstrap';import FormRange from 'react-bootstrap/esm/FormRange';

export default function BootsrtapForms(){
    return(
