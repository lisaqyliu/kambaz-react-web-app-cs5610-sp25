        ...
        <div>
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-my-favorite-recipe">
                    ...
                    <li>Place the salmon on the pan. Sprinkle with olive oil, salt and pepper.</li>
                    <li>Pour lemon juice over the top and put it into the oven.</li>
                    <li>Bake, uncovered, 12-15 mintues or until salmon flakes easily with fork.</li>
                    <li>Serve and enjoy!</li>
                </ol>
            ...
            <div id="wd-forms">
                ...
                <form id="wd-text-fields">
                    ...
                    <input type="text" placeholder="Deo" value="Wonderland" title="The last name" id="wd-text-fields-last-name" />
                    <h5>Text boxes</h5>
                ...
                <br />
                <input type="radio" name="color" id="wd-radio-red"/>
                <label htmlFor="wd-radio-red">Red</label>
                <br />
                <input type="radio" name="color" id="wd-radio-yellow"/>
                <label htmlFor="wd-radio-yellow">Yellow</label>
                <br />
                <input type="radio" name="color" id="wd-radio-blue"/>
                <label htmlFor="wd-radio-blue">Blue</label>
                <br />
                <input type="radio" name="color" id="wd-radio-green"/>
                ...
                <label htmlFor="wd-chkbox-fantasy">Fantacy</label><br />
                ...
                Please 
                <a href="https://github.com/lisaqyliu/kambaz-react-web-app-cs5610-sp25.git" id="wd-github">click here</a> to my GitHub Repo<br />
            </div>
        </div>
    );
}